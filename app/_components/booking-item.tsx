  ...
  return (
    <Sheet>
      <SheetTrigger asChild>
        <Card className="min-w-full">
          <CardContent className="flex py-0 px-0">
            <div className="flex flex-col flex-[3] gap-2 py-5 px-5">
      ...
      <SheetContent className="px-0">
        <SheetHeader className=" px-5 text-start pb-6 border-b border-solid border-secondary">
        ...
        <div className="px-5">
          <div className="relative h-[180px] w-full mt-6">
            <Image
              src="/image-map.png" fill alt={booking.barbershop.name} />
